...
const Button: FC<ButtonProps> = ({
    ...
    return (
        <button
            ...
            className="bg-[var(--bg-color)] text-[var(--text-color)] 2xl:w-87.5 xl:w-75 lg:w-75 md:w-50 w-full group flex items-center justify-between 2xl:px-12.5 lg:px-10 px-5 2xl:py-5.5 lg:py-3 py-2 xl:text-2xl lg:text-xl md:text-lg text-base font-bold rounded-full transition-all duration-300 border border-transparent hover:border-[var(--shadow-color)] hover:shadow-[8px_8px_0_var(--shadow-color)]"
        >
            <span>{label}</span>
